...
Invoice, receipt, quote, estimate, and credit note share the persisted invoice payload, but each document type owns its own labels, metadata, and supporting sections. Document-specific fields must remain optional so older saved drafts and invoices continue to load.
