...
export function AboutPage() {
  return (
    <PageShell eyebrow="About Invoice Focus" title="Invoicing That Keeps the Focus on Your Work." description="Invoice Focus helps freelancers, independent professionals, and growing teams create clear invoices without adding another complicated system to their day.">
      <div className="grid gap-6 lg:grid-cols-3">
        {[
          ['Our Mission', 'Make the business side of meaningful work feel straightforward, professional, and calm.'],
          ['Why People Choose Us', 'Invoice Focus brings the essential invoice workflow into one focused experience, with thoughtful defaults that save time.'],
      ...
      <div className="mt-6 grid gap-6 rounded-2xl border border-border/80 bg-card p-8 shadow-sm md:grid-cols-[1fr_auto] md:items-center">
        <div>
          ...
          <p className="mt-3 max-w-2xl leading-relaxed text-muted-foreground">We build for real working days: busy, collaborative, and full of details. Every part of Invoice Focus is designed to help you communicate clearly and move work forward.</p>
        </div>
...
export function StatusPage() {
  return (
    <PageShell eyebrow="System Status" title="Invoice Focus Is Running Smoothly." description="A clear view of the services that support your invoicing workflow.">
...
export function ContactPage() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const subject = encodeURIComponent(`Invoice Focus inquiry from ${data.get('name') || 'a visitor'}`)
  ...
  return (
   <PageShell eyebrow="Contact Invoice Focus" title="Questions? We’re Here to Help." description="Tell us what you’re working on or what would make invoicing easier. We typically respond within 12–24 hours during business days.">
