...
export function ContactPage() {
  ...
  return (
    <PageShell eyebrow="Contact InvoiceFocus" title="Questions? We’re here to help." description="Tell us what you’re working on or what would make invoicing easier. We typically respond within one business day.">
      <div className="grid gap-6 lg:grid-cols-[1fr_1.35fr]">
        <div className="space-y-4">
          ...
          <Card><CardHeader><Clock3 className="h-5 w-5 text-primary" aria-hidden="true" /><CardTitle className="mt-3">Response expectations</CardTitle></CardHeader><CardContent><p className="text-sm leading-relaxed text-muted-foreground">Send us a note any time. Our team reviews messages during business hours and usually replies within one business day.</p></CardContent></Card>
