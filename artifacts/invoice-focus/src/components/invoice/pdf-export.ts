...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  @media screen and (max-width: 680px) { .invoice { padding: 5mm; } .header, .columns { grid-template-columns: 1fr; } .header-right, .column-right { text-align: left; } .column-right { grid-template-columns: 1fr 1fr; } }
