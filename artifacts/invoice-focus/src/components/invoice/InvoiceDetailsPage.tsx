...
export default function InvoiceDetailsPage({ id }: { id: string }) {
  ...
  const defaultSubject = invoice ? `${documentLabel} ${invoice.invoice_number} from InvoiceFocus` : ''
